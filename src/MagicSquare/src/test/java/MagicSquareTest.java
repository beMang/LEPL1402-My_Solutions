...
public class MagicSquareTest {
    ...
    @GradeFeedback(message = "Verify all different",onFail=true)
    ...
    @Test
    @Grade(value = 1, cpuTimeout = 1000)
    @GradeFeedback(message = "Verify permutation ",onFail=true)
    ...
    @Test
    @Grade(value = 1, cpuTimeout = 1000)
    @GradeFeedback(message = "Verify the sum of columns/rows",onFail=true)
    ...
    @Test
    @Grade(value = 1, cpuTimeout = 1000)
    @GradeFeedback(message = "Verify sum of diagonals",onFail=true)
    ...
    @Test
    @Grade(value = 1, cpuTimeout = 1000)
    @GradeFeedback(message = "Verify the range of values {1..n*n}",onFail=true)
